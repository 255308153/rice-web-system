...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train rice type classifier and export .keras model")
    parser.add_argument("--data-dir", required=True, help="Directory with class subfolders")
    parser.add_argument("--output", default="models/rice_classifier.keras", help="Output .keras path")
    ...
    labels_path = output_path.with_name("rice_labels.txt")
